...
G4ELINP_DetectorConstruction::G4ELINP_DetectorConstruction():fWorldLogic(0){
    ...
    bScoringCSPEC = 0;	//0 -> Large scoring screen, 1 -> CSPEC box scoring, 2 -> large CSPEC box scoring
...
G4VPhysicalVolume* G4ELINP_DetectorConstruction::Construct(){
    ...
    if(bBeamPipe){
        ...
        fBeamPipeA1Logic = new G4LogicalVolume(fBeamPipeA1Solid,
                                               fBeamPipeMaterial,
                                               "BeamPipeA1");
       ...
       G4Tubs* fBeamPipeA1InsideSolid = new G4Tubs("BeamPipeA1Inside",
        ...
        G4LogicalVolume* fBeamPipeA1InsideLogic = new G4LogicalVolume(fBeamPipeA1InsideSolid,
                                               							fBeamPipeVacuum,
                                               							"BeamPipeA1Inside");
		...
		fBeamPipeA1InsidePhysical = new G4PVPlacement(0,
                                                	fBeamPipeA1PositionVector,
                                               	    fBeamPipeA1InsideLogic,
                                                	"BeamPipeA1Inside",
                                               		fWorldLogic,
                                               		false,
                                               		0);
