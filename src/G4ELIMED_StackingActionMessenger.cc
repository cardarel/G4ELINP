...
// ********************************************************************
//
/// \file hadronic/Hadr01/src/G4ELIMED_StackingActionMessenger.cc
/// \brief Implementation of the G4ELIMED_StackingActionMessenger class
//
// $Id$
//
/////////////////////////////////////////////////////////////////////////
...
G4ELIMED_StackingActionMessenger::G4ELIMED_StackingActionMessenger(G4ELIMED_StackingAction* stack)
:fStackAction(stack)
{
...
G4ELIMED_StackingActionMessenger::~G4ELIMED_StackingActionMessenger()
{
  delete fKillCmd;
  delete fKCmd;
}
...
void G4ELIMED_StackingActionMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{     
  if(command == fKillCmd) {
