...
G4VPhysicalVolume* G4ELIMED_DetectorConstruction::Construct(){
	...
	//A1B0 concrete block for shield -no hole
        ...
        G4Box* fConcreteA1B0Solid = new G4Box("ConcreteA1B0",
                                              ...
                                              fConcreteA1Length * 0.5); //??EDIT TO CHECK CONCRETE THICKNESS SHIELDING 
   ...
   //A1B2 Hole for Pb pipe cap
        G4Box* fConcreteA1B2Solid = new G4Box("ConcreteA1B2",
                                              ...
                                              (fA1LeadPipeCapLength + 10.*CLHEP::mm) * 0.5 + + 10.*CLHEP::mm); // 10 cm added to avoid error in subtraction, willdisappear in subtraction shitf
     ...
     //A1Solid concrete block for shield with hole for the pipe and for Lead cap
        G4SubtractionSolid* fConcreteA1B0B1B2Solid = new G4SubtractionSolid("ConcreteA1B0B1B2", fConcreteA1B0B1Solid, fConcreteA1B2Solid,
        																	0, 
        																	G4ThreeVector(0.,
        																				  25.*CLHEP::cm,
        																				  -(fConcreteA1Length-(fA1LeadPipeCapLength + 10.*CLHEP::mm)) * 0.5 - 10.*CLHEP::mm
        																				  )
        																	);     
        ...
        fA1LeadPipeCapLogic = new G4LogicalVolume(fA1LeadPipeCapSolid,
                                               fPbDiskMaterial,
                                               "A1LeadPipeCap");
