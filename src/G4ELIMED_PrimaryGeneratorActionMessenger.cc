...
// ********************************************************************
//
/// \file hadronic/Hadr01/src/G4ELIMED_PrimaryGeneratorActionMessenger.cc
/// \brief Implementation of the G4ELIMED_PrimaryGeneratorActionMessenger class
//
// $Id$
//
/////////////////////////////////////////////////////////////////////////

#include "G4ELIMED_PrimaryGeneratorActionMessenger.hh"
...
G4ELIMED_PrimaryGeneratorActionMessenger::G4ELIMED_PrimaryGeneratorActionMessenger(G4ELIMED_PrimaryGeneratorAction* stack)
:fPrimaryGeneratorAction(stack){
  fReadFromFileCmd = new G4UIcmdWithABool("/gun/ReadFromFile",this);
  fReadFromFileCmd->SetGuidance(" Choice : true false");
...
G4ELIMED_PrimaryGeneratorActionMessenger::~G4ELIMED_PrimaryGeneratorActionMessenger(){
...
void G4ELIMED_PrimaryGeneratorActionMessenger::SetNewValue(G4UIcommand* command, G4String newValue){
