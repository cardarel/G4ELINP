...
G4ELINP_SensitiveDetector::G4ELINP_SensitiveDetector(G4String name):G4VSensitiveDetector(name)
{
    G4String HCname;
...
bool G4ELINP_SensitiveDetector::ProcessHits(G4Step* aStep, G4TouchableHistory* /*ROhist*/)
{   
...
void G4ELINP_SensitiveDetector::EndOfEvent(G4HCofThisEvent* /*HCE*/){}
