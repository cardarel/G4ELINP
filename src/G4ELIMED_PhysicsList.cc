...
// ********************************************************************
//
// $Id: G4ELIMED_PhysicsList.cc 73290 2013-08-23 10:04:20Z gcosmo $
//
/// \file radioactivedecay/rdecay02/src/G4ELIMED_PhysicsList.cc
/// \brief Implementation of the G4ELIMED_PhysicsList class
...
#include "G4ELIMED_PhysicsListMessenger.hh"
...
G4ELIMED_PhysicsList::G4ELIMED_PhysicsList() :
...
fPMessenger(0)
{
    ...
    fPMessenger = new G4ELIMED_PhysicsListMessenger(this);
...
void G4ELIMED_PhysicsList::ConstructParticle()
{
...
void G4ELIMED_PhysicsList::ConstructProcess()
{
    AddTransportation();
    ...
    G4cout << "### G4ELIMED_PhysicsList::ConstructProcess is done" << G4endl;    
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void G4ELIMED_PhysicsList::SelectPhysicsList(const G4String& name)
{
    if (verboseLevel>1) {
        G4cout << "G4ELIMED_PhysicsList::SelectPhysicsList: <" << name << ">" << G4endl;
    }
    if (name == "QGSP_BIC") {
        delete fHadPhysicsList;
        ...
        G4cout << "G4ELIMED_PhysicsList WARNING wrong or unkonwn <"
        << name << "> Physics " << G4endl;
    }
}
...
void G4ELIMED_PhysicsList::SetCuts()
{
...
void G4ELIMED_PhysicsList::SetCutForGamma(G4double cut)
{
    fCutForGamma = cut;
...
void G4ELIMED_PhysicsList::SetCutForElectron(G4double cut)
{
    fCutForElectron = cut;
...
void G4ELIMED_PhysicsList::SetCutForPositron(G4double cut)
{
    fCutForPositron = cut;
...
void G4ELIMED_PhysicsList::SetTargetCut(G4double cut)
{
...
void G4ELIMED_PhysicsList::SetDetectorCut(G4double cut)
{
