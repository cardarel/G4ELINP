...
// ********************************************************************
//
/// \file analysis//include/G4ELIMED_EventAction.hh
/// \brief Definition of the G4ELIMED_EventAction class
//
// $Id$
// --------------------------------------------------------------
//
...
G4ELIMED_FileReader::G4ELIMED_FileReader(G4String fileName){
    fFileName = fileName;
...
G4ELIMED_FileReader::~G4ELIMED_FileReader(){
    inputFile.close();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void G4ELIMED_FileReader::SetFileName(G4String vFileName){
    fFileName=vFileName;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void G4ELIMED_FileReader::StoreEvents(){
...
G4ThreeVector G4ELIMED_FileReader::GetAnEventPosition(G4int vIndex){
    return evListPos.at(vIndex);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4ThreeVector G4ELIMED_FileReader::GetAnEventMomentum(G4int vIndex){
    return evListMom.at(vIndex);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4ThreeVector G4ELIMED_FileReader::GetAnEventSpin(G4int vIndex){
    return evListSpin.at(vIndex);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4double G4ELIMED_FileReader::GetAnEventTime(G4int vIndex){
    return evListTime.at(vIndex);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4double G4ELIMED_FileReader::GetAnEventEnergy(G4int vIndex){
    return evListEnergy.at(vIndex);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4int G4ELIMED_FileReader::GetNumberOfEvents(){
