...
G4ELIMED_PhysicsListMessenger::G4ELIMED_PhysicsListMessenger(G4ELIMED_PhysicsList* pPhys)
:G4UImessenger(),
fPPhysicsList(pPhys),
fPhysDir(0),
fGammaCutCmd(0),
...
G4ELIMED_PhysicsListMessenger::~G4ELIMED_PhysicsListMessenger()
{
    delete fPhysDir;
    delete fGammaCutCmd;
    delete fElectCutCmd;
...
void G4ELIMED_PhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                                 G4String newValue)
{
