...
// ********************************************************************
//
/// \file analysis//src/G4ELIMED_SensitiveDetectorHit.cc
/// \brief Implementation of the G4ELIMED_SensitiveDetectorHit class
//
// $Id$
// --------------------------------------------------------------
//
...
G4ThreadLocal G4Allocator<G4ELIMED_SensitiveDetectorHit>* G4ELIMED_SensitiveDetectorHitAllocator = 0;
#else
G4Allocator<G4ELIMED_SensitiveDetectorHit> G4ELIMED_SensitiveDetectorHitAllocator;
#endif

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4ELIMED_SensitiveDetectorHit::G4ELIMED_SensitiveDetectorHit()
{
    fTime = 0.;
...
G4ELIMED_SensitiveDetectorHit::G4ELIMED_SensitiveDetectorHit(const G4ELIMED_SensitiveDetectorHit &right): G4VHit(){
...
const G4ELIMED_SensitiveDetectorHit& G4ELIMED_SensitiveDetectorHit::operator=(const G4ELIMED_SensitiveDetectorHit &right)
{
    fTrackID = right.fTrackID;
    fTrackIDP = right.fTrackIDP;
    fPos = right.fPos;
...
int G4ELIMED_SensitiveDetectorHit::operator==(const G4ELIMED_SensitiveDetectorHit &/*right*/) const
{
    return 0;
}
...
void G4ELIMED_SensitiveDetectorHit::Draw()
{
...
const std::map<G4String,G4AttDef>* G4ELIMED_SensitiveDetectorHit::GetAttDefs() const
{
    G4bool isNew;
    std::map<G4String,G4AttDef>* store = G4AttDefStore::GetInstance("G4ELIMED_SensitiveDetectorHit",isNew);
    if (isNew) {
        G4String ID("ID");
...
std::vector<G4AttValue>* G4ELIMED_SensitiveDetectorHit::CreateAttValues() const
{
    ...
    values->push_back(G4AttValue("eP",G4BestUnit(fEnergyPrevious,"Energy"),""));
...
void G4ELIMED_SensitiveDetectorHit::Print()
{
